	...
	public AddStudent(JFrame main) {
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String dob = "1994-12-25";//lblDate.getText().trim();
					...
					if (isGoodToGo){
						try {
							...
							if (t[0].equals("-1")){
								...
								int rslt = JOptionPane.showConfirmDialog (null, "Is your mother: "+ t[0] + "\nAnd father: "+ t[2]);
								if (rslt==JOptionPane.YES_OPTION){
									...
									JOptionPane.showMessageDialog(null, "Please put the accurate family id.", "Info", JOptionPane.INFORMATION_MESSAGE);
								}
							}
